...
export const collectionApi = {
    ...
    updateSpherePerks: async (
        id: string,
        perks: CollectionEntrySpherePerks
    ) => {
...
export const listsApi = {
    ...
    addToWishlist: async (request: CreateWishlistEntryRequest) => {
        const { data } = await api.post<WishlistEntry>(
            '/lists/wishlist',
            request
        );
        return data;
...
export const kakeraApi = {
    ...
    exportClaims: async () => {
        const { data } = await api.get<KakeraClaimExportItem[]>(
            '/kakera/export'
        );
        return data;
    },
...
export const calculatorApi = {
    ...
    create: async (request: CreateCalculatorConfigRequest) => {
        const { data } = await api.post<CalculatorConfig>(
            '/calculator',
            request
        );
        return data;
