...
function ProfilePage() {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: intentional - reset edits on server data change
    useEffect(() => {
        setLocalEdits({});
    }, [serverProfile]);
    ...
    const getValue = useCallback(
        (key: ProfileFieldKey): number => {
            if (key in localEdits) {
                // biome-ignore lint/style/noNonNullAssertion: guarded by key-in check above
        ...
        <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">
                                                Each perk must be at least level{" "}
                                                {maxLevel - 1} before any perk
                                                can reach level {maxLevel}.
                                            </p>
                                            <p className="text-sm text-muted-foreground mt-1">
                                                Behind:{" "}
                                                {validation.issues
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Manual settings for roll calculations (cannot be
                        auto-imported)
                    </CardDescription>
                </CardHeader>
                <CardContent>
