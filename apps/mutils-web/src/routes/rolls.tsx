                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                                Based on your imported collection and profile
                                settings
                            </p>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <StatsCard
                    ...
                    items={[
                        {
                            label: "Total Owned",
                            value: inputs.ownedTotal.toLocaleString(),
                        },
                        {
                    ...
                    items={[
                        {
                            ...
                            value: inputs.totalRolls.toString(),
                        },
                        {
                        ...
                        {
                            label: "Effective Rolls/Hour",
                            value: effectiveRolls.toString(),
                        },
                    ]}
                />
                ...
                <StatsCard
                    ...
                    items={[
                        ...
                        },
                        {
                            ...
                            value: `Level ${inputs.perk2} (+${
                                inputs.perk2 * 50
                            }%)`,
                        },
                        {
                            label: "Perk 4 (Double Key)",
                            value: `Level ${inputs.perk4} (+${
                                inputs.perk4 * 10
                            }%)`,
                        },
                    ]}
                ...
                <>
                    <div className="mt-8 flex items-center justify-between">
                        ...
                        <div className="flex gap-1 bg-muted rounded-lg p-1">
                            {(
                                Object.keys(TIMEFRAME_CONFIG) as TimeframeKey[]
                            ).map((key) => (
                                <Button
                                    key={key}
                                    variant={
                                        timeframe === key ? "default" : "ghost"
                                    }
                                    size="sm"
                    ...
                    <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <ResultCard
                            ...
                            value={`~${Math.round(
                                estimatedHourlyKakera
                            ).toLocaleString()}`}
                            subtext={`${effectiveRolls} rolls × ${(
                                totalHitChance * 100
                            ).toFixed(
                                2
                            )}% hit rate × ${avgKakeraPerClaim.toFixed(0)} avg`}
                            variant="info"
                        />
        ...
        <Card className={`glass ${variantStyles[variant]}`}>
            <CardContent>
                <div className="flex items-center justify-between">
                    ...
                    {mult && (
                        <Badge variant={badgeVariants[variant]}>{mult}x</Badge>
                    )}
                </div>
                {value && (
                    <p
                ...
                {percent && (
                    <div className="mt-2 flex items-center justify-between gap-2 flex-wrap">
                        <p
                            className={`text-3xl font-bold ${textStyles[variant]}`}
                        >
                            {percent}
                        </p>
                        {odds && (
