...
function calculateOptimalBW(
    ...
    for (let invested = 0; invested <= inputs.totalRolls; invested++) {
        ...
        const starwishMult =
            starwishBase + wishBonus / 100 + starwishBonus / 100;
                ...
                try {
                    ...
                    if (Array.isArray(imported)) {
                        ...
                        if (validImports.length > 0) {
                            ...
                            setImportError(
                                'No valid configurations found in the JSON file.',
                            );
                        }
                    } else {
                        setImportError(
                ...
                <CardHeader>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <CardDescription>
                                Experiment with different stats to see how they
                                affect your odds.
                            </CardDescription>
                        </div>
                    </div>
                ...
                {inputs.bwRollsInvested > 0 && (
                    <div className="mt-4 p-3 bg-info/10 border border-info/30 rounded-lg">
                        ...
                        <p className="text-xs text-muted-foreground/70 mt-1">
                            Each roll invested grants +20% wish spawn (decreases
                            at thresholds: 15% after 5, 10% after 15, 5% after
                            100, 1% after 200) and +10% starwish (5% after 100,
                            1% after 200)
                        </p>
                    </div>
                )}
