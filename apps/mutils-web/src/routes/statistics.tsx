...
function StatisticsPage() {
    ...
    const [pieChartMode, setPieChartMode] = useState<"value" | "count">(
        "value"
    );
    ...
    const handleExportStatistics = () => {
        ...
        const statisticsExport = {
            ...
            summary: {
                ...
                successRate:
                    claims.length > 0
                        ? `${Math.round(
                              (claims.filter((c) => c.isClaimed).length /
                                  claims.length) *
                                  100
                          )}%`
                        : "0%",
            ...
            linearGrowthModel: linearResult
                ? {
                      ...
                      rSquaredPercent: `${(linearResult.rSquared * 100).toFixed(
                          2
                      )}%`,
        ...
        const a = document.createElement("a");
        a.href = url;
        a.download = `kakera-statistics-${format(
            new Date(),
            "yyyy-MM-dd"
        )}.json`;
        a.click();
    ...
    const startDate = config.days
        ? startOfDay(subDays(now, config.days))
        : null;
    ...
    const daysToTargetLast7 =
        last7DaysTotal > 0
            ? Math.ceil(remaining / (last7DaysTotal / 7))
            : Infinity;
                ...
                for (const daysAhead of futureDays) {
                    ...
                    predictions.push({
                        ...
                        cumulative: Math.round(
                            currentBaseline + cumulativeFuture
                        ),
                    });
                }
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Time Range Selector */}
            <div className="flex flex-wrap gap-2">
                {(Object.keys(TIME_RANGE_CONFIG) as TimeRange[]).map(
                    (range) => (
                        <Button
                            key={range}
                            variant={
                                timeRange === range ? "default" : "secondary"
                            }
                            size="sm"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="glass">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <ChartBarIcon size={20} /> Daily Kakera Gain (
                            {config.label})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="glass">
                    <CardHeader>
                        <div className="flex items-center justify-between w-full">
                            <CardTitle className="flex items-center gap-2">
                                <ChartPieIcon size={20} /> Distribution by Type
                                ({config.label})
                            </CardTitle>
                            ...
                            {pieData.map((entry) => (
                                ...
                                >
                                    <div
                                        ...
                                        style={{
                                            backgroundColor: getKakeraColor(
                                                entry.type
                                            ),
                                        }}
                                    />
                ...
                <Card className="glass">
                    <CardHeader>
                        <div className="flex items-center justify-between w-full">
                            <CardTitle className="flex items-center gap-2">
                                <GaugeIcon size={20} /> Average per Type (
                                {config.label})
                            </CardTitle>
                            <Select
                ...
                <Card className="glass">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <ChartBarIcon size={20} /> Claims per Day (
                            {config.label})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="glass">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <CalendarIcon size={20} /> Claims by Day of Week (
                            {config.label})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="glass lg:col-span-2">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            <TrendUpIcon size={20} /> Cumulative Growth (
                            {config.label})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        ...
                        <div className="p-6 pt-0 space-y-8 border-t border-border">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-6">
                                ...
                                <div className="bg-muted/50 rounded-lg p-4">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                        {activeDaysCount} of {dailyData.length}{" "}
                                        days active
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-muted/30 rounded-xl p-6">
                                ...
                                <p className="text-sm text-muted-foreground mb-4">
                                    Uses linear regression on daily income to
                                    find your earnings velocity (rate of
                                    growth), then projects future cumulative
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-secondary/50 rounded-lg p-4">
                                            ...
                                            <p className="font-mono text-sm text-foreground">
                                                daily_income ={" "}
                                                {linearResult.intercept.toFixed(
                                                    2
                                                )}{" "}
                                                + (
                                                {linearResult.slope.toFixed(2)}{" "}
                                                × day)
                                            </p>
                                            <p className="text-xs text-muted-foreground mt-2">
                                                {linearResult.slope >= 0
                                        ...
                                        <div>
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                                                {linearResult.predictions.map(
                                                    (prediction) => {
                                                        const daysAhead =
                                                            prediction.day -
                                                            linearResult.lastDayInData;
                                                        return (
                                                            <div
                                                                key={
                                                                    prediction.day
                                        ...
                                        <div className="bg-secondary/30 rounded-lg p-4 text-sm">
                                            ...
                                            <ol className="list-decimal list-inside space-y-1 text-muted-foreground">
                                                <li>
                                                    ...
                                                    totals from your claim
                                                    history
                                                </li>
                                                <li>
                                                    Fits a linear regression to
                                                    find if your daily income is
                                                    trending up/down
                                                </li>
                                                <li>
                                                    Predicts future daily
                                                    incomes using the fitted
                                                    line
                                                </li>
                                                <li>
                                                    Sums predicted daily incomes
                                                    to get cumulative
                                                    projections
                                                </li>
                                            </ol>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {pendingImportData?.length || 0} claims from the
                    ...
                    <AlertDialogFooter>
                        ...
                        >
                            {importClaimsMutation.isPending
                                ? "Importing..."
                                : "Import"}
                        </AlertDialogAction>
                    </AlertDialogFooter>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {claims?.length || 0} of your kakera claims. This
            ...
            >
                <DialogContent className="sm:max-w-2xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Paste your Discord kakera log data below. The parser
                            will automatically extract kakera claims.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    setBulkImportCharacterName(e.target.value)
                                }
                                placeholder="e.g., Chisa"
                                className="h-9"
                            />
                            <p className="text-xs text-muted-foreground mt-1">
                                If provided, all claims will be associated with
                                this character.
                            </p>
                        </div>
                        <div>
