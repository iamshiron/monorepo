        ...
        <ContextMenu>
                ...
                >
                    ...
                    <div className="aspect-square bg-muted rounded-md mb-2 flex items-center justify-center overflow-hidden relative">
                        {imageSrc ? (
                            ...
                            <span className="text-muted-foreground/70 text-3xl">
                                ?
                            </span>
                        )}
                    </div>
                    ...
                    {character.kakeraStats &&
                        character.kakeraStats.totalValue > 0 && (
            ...
            <ContextMenuContent>
                ...
                {wishlistStatus ? (
                    ...
                    <>
                        <ContextMenuItem
                            onClick={() => onAddToWishlist(entry, false)}
                        >
                            <StarIcon size={14} className="mr-2" />
                            Add to Wishlist
                        </ContextMenuItem>
                        <ContextMenuItem
                            onClick={() => onAddToWishlist(entry, true)}
                        >
                            <StarIcon
                                size={14}
