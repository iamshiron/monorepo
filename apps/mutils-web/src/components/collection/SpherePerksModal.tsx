...
export function SpherePerksModal({
    ...
    const hasChanges =
        JSON.stringify(localPerks) !==
        JSON.stringify(serverPerks ?? EMPTY_PERKS);
            ...
            <DialogContent className="sm:max-w-[75%] max-h-[85vh] overflow-y-auto">
                            ...
                            {SPHERE_PERKS.map((perk) => (
                                ...
                                >
                                    ...
                                    {perk.isBoolean ? (
                                        <Switch
                                            checked={
                                                localPerks[perk.key] as boolean
                                            }
                                        ...
                                        <LevelSelect
                                            value={
                                                localPerks[perk.key] as number
                                            }
                                            onChange={(v) =>
                                                updatePerk(perk.key, v)
                                            }
                                            max={5}
                                        />
                                    )}
                ...
                <DialogFooter>
                    ...
                    <Button
                        onClick={handleSave}
                        disabled={
                            !hasChanges || saveMutation.isPending || isLoading
                        }
                    >
