                ...
                <div className="space-y-6 px-6 pb-6">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-3">
                            {stats &&
                                Object.keys(stats.keyDistribution).length >
                                    0 && (
                                    <div className="flex gap-1.5 flex-wrap">
                                        {Object.entries(stats.keyDistribution)
                                            ...
                                            .map(([key, count]) => {
                                                ...
                                                const isSelected =
                                                    filters.selectedKeyTypes.includes(
                                                        key
                                                    );
                                                return (
                                                    <button
                    ...
                    <div className="space-y-4">
                        ...
                        {seriesList && seriesList.length > 0 ? (
                                        ...
                                        {filteredSeriesList.length === 0 ? (
                                            ...
                                            filteredSeriesList.map((series) => (
                                                ...
                                                >
                                                    ...
                                                    {filters.selectedSeries.includes(
                                                        series.name
                                                    ) && (
                                                        <CheckIcon
                                                            size={14}
                            ...
                            <p className="text-sm text-muted-foreground">
                                No series in your collection. Import series data
                                to filter by series.
                            </p>
                        )}
                        {filters.selectedSeries.length > 0 && (
